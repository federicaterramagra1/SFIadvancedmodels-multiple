...
def build_and_quantize_once():
    ...
    # Nomi dataset/rete (fallback a *_NAME o *_)
    ...
    # Loader (ci serve sempre il test; il train solo se dobbiamo calibrare)
    ...
    if qmodel is not None:
        ...
        # 2) Altrimenti costruisci il float, carica ckpt e fai PTQ UNA volta, poi salva
    ...
    # 3) Predizioni clean (post-PTQ) batch-by-batch
    clean_by_batch = []
