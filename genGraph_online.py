...
def analyze_failure_rates():
    ...
    prefix = f"N{N}_{SETTINGS.DATASET_NAME}_{SETTINGS.NETWORK_NAME}_summary"

    csv_path = os.path.join(
        SETTINGS.FI_ANALYSIS_PATH,
        f"{SETTINGS.DATASET_NAME}_{SETTINGS.NETWORK_NAME}_online_summary_N{N}.csv"
    )
    fault_list_path = os.path.join(
        SETTINGS.FAULT_LIST_PATH,
        f"{SETTINGS.NETWORK_NAME}_42_fault_list_N{N}.csv"
    )
    ...
    with open(os.path.join(base_path, "summary.txt"), "w") as f:
        ...
        fig1.savefig(os.path.join(base_path, "failure_rate_distribution.png"))
        ...
        fig2.savefig(os.path.join(base_path, "accuracy_vs_failure_rate.png"))
        ...
        top100_detailed.to_csv(os.path.join(base_path, "top100_online_faults.csv"), index=False)
        ...
        layer_stats.to_csv(os.path.join(base_path, "layer_stats_summary.csv"))
